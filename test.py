...
def start_pool():
    ...
    dsn = cx_Oracle.makedsn(HOST_NAME, PORT_NUMEBER, service_name=SERVICE_NAME) # if needed, place an 'r' before any parameter in order to address special characters such as '\'.
